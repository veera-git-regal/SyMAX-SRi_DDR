...
#define MAX_APPLICATION_SPEED_RPM       2250 /*!< rpm, mechanical */
...
/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD              0.4 /*!<Maximum accepted 
//                                                            variance on speed 
...
#define SW_DEADTIME_NS                   1500 /*!< Dead-time to be inserted  
...
#define PID_SPEED_KI_DEFAULT          500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          520 /*!< Over-voltage 
                                                         threshold */
