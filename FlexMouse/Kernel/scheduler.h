...
#define MODULE_USART1_TOTAL_SEQ        7
...
#define TOTAL_NUM_OF_PROCESSES 16        // Pam: Let kernal assign total number of process to execute
...
#define SEQ_MEM_ID_MODULE_I2C_TX                7
#define SEQ_MEM_ID_MODULE_I2C_RX                8
#define TOTAL_NUM_OF_SEQ_MEM_INSTANCES 9 // should always be the last member of this enum
//};
