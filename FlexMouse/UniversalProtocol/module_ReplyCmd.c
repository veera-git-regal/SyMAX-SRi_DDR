...
#define ENABLE_PROTOCOLBUF_REPLYCMD_FIXED_LEN 1
  ...
  #define RX_REPLYCMD_LENGTH 16 // This buffer only catches the one message, message is actually length 9
  ...
  switch (next_State_u8)
    {
      ...
      case RUN_APP:
        { 
          ...
          #if ENABLE_PROTOCOLBUF_REPLYCMD_FIXED_LEN <= 0
                ...
                case 4:
                 ...
                 case 8: // TODO: Magic Number, make these requests have IDs
                  { //BulkMonitoring Request
                    uint8_t message[] = {0x55, 30, 0x4D, 0x00, 0x00, 
													  ...
													  //0xff, 0xff, 0xff, // sm_state_u16, error_code_u8
													  //0xff, 0xff, 0xff, 0xff,
													  //0xff, 0xff, 0xff, 0xff,
													  //0xff, 0xff, 0xff, 0xff,
													  //0xff, // debug_id_code_ 
